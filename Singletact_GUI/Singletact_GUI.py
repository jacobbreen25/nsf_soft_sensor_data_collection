...
class FlexSense_Gui(tk.Tk):
    ...
    async def construct_gui(self):
        self.title("Singletact Data Collection")
        self.resizable()
        self.tasks = []

        f = [tk.Frame(master=self)]
        lHeader = tk.Label(master=f[-1], text="Singletact Data Collection", font=self.title_font)
        ...
        def acquireMOCAPCOMList():
            ...
            #self.after(100, acquireMOCAPCOMList)
        ...
        bMocapReset = tk.Button(master=f[-1], text="Update COM Options", command=lambda: acquireMOCAPCOMList(), width=20)
        ...
        f.append(tk.Frame(master=self))
        lDataLabel1 = tk.Label(master=f[-1], text="Data 1")
        lDataLabel1.grid(column=0, row=0, padx=5, pady=5)
        lDataLabel2 = tk.Label(master=f[-1], text="Data 2")
        lDataLabel2.grid(column=1, row=0, padx=5, pady=5)
        lDataLabel3 = tk.Label(master=f[-1], text="Data 3")
        lDataLabel3.grid(column=2, row=0, padx=5, pady=5)
        lDataLabel4 = tk.Label(master=f[-1], text="Data 4")
        lDataLabel4.grid(column=3, row=0, padx=5, pady=5)
        lDataLabel5 = tk.Label(master=f[-1], text="Data 5")
        lDataLabel5.grid(column=4, row=0, padx=5, pady=5)
        lDataLabel6 = tk.Label(master=f[-1], text="Data 6")
        lDataLabel6.grid(column=5, row=0, padx=5, pady=5)
        lDataLabel7 = tk.Label(master=f[-1], text="Data 7")
        lDataLabel7.grid(column=6, row=0, padx=5, pady=5)
        lDataLabel8 = tk.Label(master=f[-1], text="Data 8")
        lDataLabel8.grid(column=7, row=0, padx=5, pady=5)
        lDataLabel9 = tk.Label(master=f[-1], text="Motor 1")
        lDataLabel9.grid(column=8, row=0, padx=5, pady=5)
        lDataLabel10 = tk.Label(master=f[-1], text="Motor 2")
        lDataLabel10.grid(column=9, row=0, padx=5, pady=5)
        self.vData0 = tk.StringVar(master=f[-1], value="0000")
        self.lData0 = tk.Label(master=f[-1], textvariable=self.vData0, anchor=tk.CENTER)
        self.lData0.grid(column=0, row=1, padx=5, pady=5)
        self.vData1 = tk.StringVar(master=f[-1], value="0000")
        self.lData1 = tk.Label(master=f[-1], textvariable=self.vData1, anchor=tk.CENTER)
        self.lData1.grid(column=1, row=1, padx=5, pady=5)
        self.vData2 = tk.StringVar(master=f[-1], value="0000")
        self.lData2 = tk.Label(master=f[-1], textvariable=self.vData2, anchor=tk.CENTER)
        self.lData2.grid(column=2, row=1, padx=5, pady=5)
        self.vData3 = tk.StringVar(master=f[-1], value="0000")
        self.lData3 = tk.Label(master=f[-1], textvariable=self.vData3, anchor=tk.CENTER)
        self.lData3.grid(column=3, row=1, padx=5, pady=5)
        self.vData4 = tk.StringVar(master=f[-1], value="0000")
        self.lData4 = tk.Label(master=f[-1], textvariable=self.vData4, anchor=tk.CENTER)
        self.lData4.grid(column=4, row=1, padx=5, pady=5)
        self.vData5 = tk.StringVar(master=f[-1], value="0000")
        self.lData5 = tk.Label(master=f[-1], textvariable=self.vData5, anchor=tk.CENTER)
        self.lData5.grid(column=5, row=1, padx=5, pady=5)
        self.vData6 = tk.StringVar(master=f[-1], value="0000")
        self.lData6 = tk.Label(master=f[-1], textvariable=self.vData6, anchor=tk.CENTER)
        self.lData6.grid(column=6, row=1, padx=5, pady=5)
        self.vData7 = tk.StringVar(master=f[-1], value="0000")
        self.lData7 = tk.Label(master=f[-1], textvariable=self.vData1, anchor=tk.CENTER)
        self.lData7.grid(column=7, row=1, padx=5, pady=5)
        self.vData8 = tk.StringVar(master=f[-1], value="0000")
        self.lData8 = tk.Label(master=f[-1], textvariable=self.vData2, anchor=tk.CENTER)
        self.lData8.grid(column=8, row=1, padx=5, pady=5)
        self.vData9 = tk.StringVar(master=f[-1], value="0000")
        self.lData9 = tk.Label(master=f[-1], textvariable=self.vData3, anchor=tk.CENTER)
        self.lData9.grid(column=9, row=1, padx=5, pady=5)
    ...
    async def callback(self, characteristic, d : bytearray):
        ...
        if (self.lastPacketTime is None or currenttime - self.lastPacketTime >= (1000 - 130)/int(self.samplerate)):
            ...
            self.vData0.set(data_array[1].zfill(4))
            self.vData1.set(data_array[2].zfill(4))
            self.vData2.set(data_array[3].zfill(4))
            self.vData3.set(data_array[4].zfill(4))
            self.vData4.set(data_array[5].zfill(4))
            self.vData5.set(data_array[6].zfill(4))
            self.vData6.set(data_array[7].zfill(4))
            self.vData7.set(data_array[8].zfill(4))
            self.vData8.set(data_array[9].zfill(4))
            self.vData9.set(data_array[10].zfill(4))
    ...
    async def bluetoothDaemon(self):
        ...
        while(self.isActive):
            ...
            if (glb_command == "connect"):
                glb_command = str
                task = asyncio.create_task(self.connect_bluetooth("MyomoSensorBLE"))
                await task
